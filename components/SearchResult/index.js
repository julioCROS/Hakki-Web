            ...
            <div className={styles.professorBox}>
              <div className={styles.mainInfo}>
                ...
                <p className={styles.values}>
                  {professor.mediaQualidade == null ? <p>X</p> : professor.mediaQualidade >= 7 ? <p className={styles.goodAvg}>{professor.mediaQualidade.toFixed(1)}</p> :professor.mediaQualidade >= 5 ? <p className={styles.neutralAvg}>{professor.mediaQualidade.toFixed(1)}</p> : <p className={styles.chaoticAvg}>{professor.mediaQualidade.toFixed(1)}</p>}
                  {professor.mediaFacilitacao == null ? <p>X</p> : professor.mediaFacilitacao >= 7 ? <p className={styles.goodAvg}>{professor.mediaFacilitacao.toFixed(1)}</p> :professor.mediaFacilitacao >= 5 ? <p className={styles.neutralAvg}>{professor.mediaFacilitacao.toFixed(1)}</p> : <p className={styles.chaoticAvg}>{professor.mediaFacilitacao.toFixed(1)}</p>}
                  {professor.mediaQualidade == null  ? <p>X</p> : ((professor.mediaQualidade + professor.mediaFacilitacao) / 2) >= 7 ? <p className={styles.goodAvg}>{((professor.mediaQualidade + professor.mediaFacilitacao) / 2).toFixed(1)}</p> :((professor.mediaQualidade + professor.mediaFacilitacao) / 2) >= 5 ? <p className={styles.neutralAvg}>{((professor.mediaQualidade + professor.mediaFacilitacao) / 2).toFixed(1)}</p> : <p className={styles.chaoticAvg}>{((professor.mediaQualidade + professor.mediaFacilitacao) / 2).toFixed(1)}</p>}
                </p>
              </div>
